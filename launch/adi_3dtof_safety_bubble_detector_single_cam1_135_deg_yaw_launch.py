"""
Compact Launch File: Camera 1 at 135° Yaw

This file has been refactored to use the unified launch system.
It calls the unified launch file with the cam1_135deg orientation preset.
...
For direct usage of the unified launch:
    ros2 launch adi_3dtof_safety_bubble_detector adi_3dtof_safety_bubble_detector_unified_single_camera_launch.py orientation:=cam1_135deg
"""
