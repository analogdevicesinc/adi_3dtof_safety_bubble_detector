"""
Compact Launch File: Camera 3 at 0° Yaw (Front/Center)

This file has been refactored to use the unified launch system.
It calls the unified launch file with the cam3_0deg orientation preset.
...
For direct usage of the unified launch:
    ros2 launch adi_3dtof_safety_bubble_detector adi_3dtof_safety_bubble_detector_unified_single_camera_launch.py orientation:=cam3_0deg
"""
