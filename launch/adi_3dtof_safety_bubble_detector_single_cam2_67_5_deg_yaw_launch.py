"""
Compact Launch File: Camera 2 at 67.5° Yaw

This file has been refactored to use the unified launch system.
It calls the unified launch file with the cam2_67_5deg orientation preset.
...
For direct usage of the unified launch:
    ros2 launch adi_3dtof_safety_bubble_detector adi_3dtof_safety_bubble_detector_unified_single_camera_launch.py orientation:=cam2_67_5deg
"""
