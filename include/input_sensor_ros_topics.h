...
public:
  ...
  void closeSensor();
  void syncDepthandIr(const sensor_msgs::ImageConstPtr& depth_image, const sensor_msgs::ImageConstPtr& ab_image);
  void camInfoCallback(const sensor_msgs::CameraInfoConstPtr& cam_info);

  void IrCallback(const sensor_msgs::ImageConstPtr& ab_image);
...
private:
  ...
  message_filters::Subscriber<sensor_msgs::Image> ab_image_subscriber_;
