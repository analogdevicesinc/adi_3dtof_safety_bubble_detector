...
PROFILE_ID(SafetyBubble_RUN, 0)
PROFILE_ID(SafetyBubble_PREPROCESS, 1)
PROFILE_ID(SafetyBubble_FLOOR_DETECTION, 2)
PROFILE_ID(SafetyBubble_SAFETYBUBBLEDETECTION, 3)
PROFILE_ID(SafetyBubble_TRANSFORM2VCAM, 4)
PROFILE_ID(SafetyBubble_GetNextFrame, 5)
PROFILE_ID(SafetyBubble_RANSAC_PREPROCESS, 6)
PROFILE_ID(SafetyBubble_RANSAC_COMPUTE_MODEL, 7)
PROFILE_ID(SafetyBubble_RANSAC_COUNTWITHINDISTANCE, 8)
PROFILE_ID(SafetyBubble_RANSAC_SELECTWITHINDISTANCE, 9)
PROFILE_ID(SafetyBubble_RANSAC_OPTIMIZE_COEFFS, 10)
PROFILE_ID(SafetyBubble_RANSAC_POSTPROCESS, 11)
PROFILE_ID(SafetyBubble_RANSAC_VALIDATE_INLIERS, 12)
PROFILE_ID(SafetyBubble_RANSAC_FILTER_PTCLD, 13)
PROFILE_ID(SafetyBubble_RANSAC_REGENERATE_PTCLD, 14)
PROFILE_ID(Publish_CompressImg, 15)
PROFILE_ID(processOutput_Thread, 16)
PROFILE_ID(readInput_Thread, 17)
PROFILE_ID(RVL_EnCodeDepth_IRImg, 18)
PROFILE_ID(SafetyBubble_AB_THRESHOLD, 19)
PROFILE_ID(SafetyBubble_POINT_CLOUD, 20)
